...
// YENİ İKONLAR EKLENDİ: Moon ve Sun (Gece Modu için)
...
export default function Home() {
  ...
  return (
    // YENİ: darkMode state'ine göre en dışa "dark" class'ı ekliyoruz
    <div className={`${darkMode ? "dark" : ""} font-sans`}>
      {/* Arka plan renkleri dark:bg-slate-950 olarak güncellendi */}
      <div className="min-h-screen bg-[#f1f5f9] dark:bg-slate-950 transition-colors duration-300 print:bg-white py-12 print:py-0 px-4 flex flex-col">
        <div className="max-w-4xl mx-auto flex-grow w-full relative">
          
          {/* YENİ: Gece Modu Şalteri */}
          <button 
          ...
          <header className="text-center mb-12 print:mb-6 pt-4">
            <div className="inline-flex items-center justify-center p-3 bg-blue-600 dark:bg-blue-500 rounded-2xl mb-4 shadow-lg shadow-blue-200 dark:shadow-none text-white print:shadow-none">
              <Zap size={32} />
            </div>
